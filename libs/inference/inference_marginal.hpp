...
#ifndef _UPGMpp_INFERENCE_MARGINAL_
#define _UPGMpp_INFERENCE_MARGINAL_
...
namespace UPGMpp
{
    ...
    class CLBPInferenceMarginal : public CInferenceMarginal
    {
    public:
    ...
    class CTRPBPInferenceMarginal : public CInferenceMarginal
    {
    public:
        void infer(CGraph &graph,
                   std::map<size_t,Eigen::VectorXd> &nodeBeliefs,
    ...
    class CRBPInferenceMarginal : public CInferenceMarginal
    {
    public:
        void infer(CGraph &graph,
                   std::map<size_t,Eigen::VectorXd> &nodeBeliefs,
